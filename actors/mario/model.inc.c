...
Lights1 mario_white_lights_group = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x04000048 # solid color brown 1 - foot - all poly types
Lights1 mario_brown1_lights_group = gdSPDefLights1(
    0x39, 0x0e, 0x07,
